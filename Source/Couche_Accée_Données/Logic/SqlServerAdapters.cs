...
namespace CoucheAcceeDonnees
{
    public class SqlServerAdapters : IAdapters
    {
        ...
        public void Build_Adapters()
        {
            ...
            Dossier_Adapter.InsertCommand.CommandText = "INSERT INTO Dossier(IDDossier, RaisonSocial, Annee) VALUES (@IDDossier, @RaisonSocial, @Annee)";
            ...
            Dossier_Adapter.UpdateCommand.CommandText = "UPDATE Dossier SET IDDossier = @IDDossier, RaisonSocial = @RaisonSocial, Annee = @Annee  WHERE (IDDossier = @IDDossier) ";
            ...
            Ecritures_Adapter.InsertCommand.CommandText = "INSERT INTO Ecritures(iDate, Compte, ContrePartie, N_Ordre, Libelle, Debit, Montant, CodeJournal, Annee, JourMois, CodeLibelleAutomatique) VALUES (@iDate, @Compte, @ContrePartie, @N_Ordre, @Libelle, @Debit, @Montant, @CodeJournal, @Annee, @JourMois, @CodeLibelleAutomatique); SELECT iDate, Compte, ContrePartie, N_Ordre, Libelle, Debit, Montant, CodeJournal, Annee, JourMois, CodeLibelleAutomatique FROM Ecritures WHERE (IdEcriture = @@IDENTITY)";
            ...
            Ecritures_Adapter.UpdateCommand.CommandText = "UPDATE Ecritures SET iDate = @iDate, Compte = @Compte, ContrePartie = @ContrePartie, N_Ordre = @N_Ordre, Libelle = @Libelle, Debit = @Debit, Montant = @Montant, CodeJournal = @CodeJournal, Annee = @Annee, JourMois = @JourMois, CodeLibelleAutomatique = @CodeLibelleAutomatique WHERE (IdEcriture = @IdEcriture) ; SELECT iDate, Compte, ContrePartie, N_Ordre, Libelle, Debit, Montant, CodeJournal, Annee, JourMois, CodeLibelleAutomatique FROM Ecritures WHERE (IdEcriture = @@IDENTITY)";
